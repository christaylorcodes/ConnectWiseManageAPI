...
```
Get-CWMCompanyTeamRole [[-Condition] <String>] [[-orderBy] <String>] [[-childConditions] <String>]
...
[https://developer.connectwise.com/products/manage/rest?a=Company&e=TeamRoles&o=GET](https://developer.connectwise.com/products/manage/rest?a=Company&e=TeamRoles&o=GET)
