...
```
Get-CWMCompanyType [-id <Int32>] [[-Condition] <String>] [[-orderBy] <String>] [[-childConditions] <String>]
...
[https://developer.connectwise.com/products/manage/rest?a=Company&e=CompanyTypes&o=GET](https://developer.connectwise.com/products/manage/rest?a=Company&e=CompanyTypes&o=GET)
