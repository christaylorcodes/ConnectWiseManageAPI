...
```
Get-CWMContact [-id <Int32>] [[-Condition] <String>] [[-orderBy] <String>] [[-childConditions] <String>]
...
[https://developer.connectwise.com/manage/rest?a=Company&e=Contacts&o=GET](https://developer.connectwise.com/manage/rest?a=Company&e=Contacts&o=GET)
