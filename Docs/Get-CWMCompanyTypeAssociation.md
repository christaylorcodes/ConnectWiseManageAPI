...
```
Get-CWMCompanyTypeAssociation [-CompanyID] <Int32> [[-Condition] <String>] [[-orderBy] <String>]
...
[https://developer.connectwise.com/products/manage/rest?a=Company&e=CompanyCompanyTypeAssociations&o=GET](https://developer.connectwise.com/products/manage/rest?a=Company&e=CompanyCompanyTypeAssociations&o=GET)
