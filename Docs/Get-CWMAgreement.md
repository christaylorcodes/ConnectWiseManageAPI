...
```
Get-CWMAgreement [-id <Int32>] [[-Condition] <String>] [[-orderBy] <String>] [[-childConditions] <String>]
...
[https://developer.connectwise.com/manage/rest?a=Finance&e=Agreements&o=GET](https://developer.connectwise.com/manage/rest?a=Finance&e=Agreements&o=GET)
