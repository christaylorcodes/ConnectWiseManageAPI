...
```
Get-CWMProjectSecurityRole [[-Condition] <String>] [[-orderBy] <String>] [[-childConditions] <String>]
...
[https://developer.connectwise.com/products/manage/rest?a=Project&e=ProjectSecurityRoles&o=GET](https://developer.connectwise.com/products/manage/rest?a=Project&e=ProjectSecurityRoles&o=GET)
