...
```
Get-CWMManufacturer [-id <Int32>] [[-Condition] <String>] [[-orderBy] <String>] [[-childConditions] <String>]
...
## NOTES
Author: Chris Taylor Date: 3/22/2018

## RELATED LINKS

[https://developer.connectwise.com/manage/rest?a=Procurement&e=Manufacturers&o=GET](https://developer.connectwise.com/manage/rest?a=Procurement&e=Manufacturers&o=GET)
