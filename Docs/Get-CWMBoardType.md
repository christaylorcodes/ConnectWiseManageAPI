...
```
Get-CWMBoardType -parentId <Int32> [-id <Int32>] [[-Condition] <String>] [[-orderBy] <Object>]
...
[https://developer.connectwise.com/Products/Manage/REST?#/BoardTypes](https://developer.connectwise.com/Products/Manage/REST?#/BoardTypes)
