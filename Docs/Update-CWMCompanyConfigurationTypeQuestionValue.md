...
```
Update-CWMCompanyConfigurationTypeQuestionValue [-ConfigurationTypeId] <Int32> [-ID] <Int32>
 [-QuestionId] <Int32> [-Operation] <String> [-Path] <String> [-Value] <Object> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
