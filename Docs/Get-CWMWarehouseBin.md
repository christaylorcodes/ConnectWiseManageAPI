...
```
Get-CWMWarehouseBin [[-id] <Int32>] [-count] [[-condition] <String>] [[-orderBy] <String>]
...
### EXAMPLE 1
```powershell
Get-CWMWarehouseBin -all
```

Will return all warehouse bins in all warehouses

### EXAMPLE 2
```powershell
Get-CWMWarehouseBin -Condition "name = 'Office'" -all
```

Will return all warehouse bins in the warehouse with the name 'Office'
