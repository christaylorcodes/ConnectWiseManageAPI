...
```
Get-CWMCompanyStatus [-id <Int32>] [[-Condition] <String>] [[-orderBy] <String>] [[-childConditions] <String>]
...
[https://developer.connectwise.com/manage/rest?a=Company&e=CompanyStatuses&o=GET](https://developer.connectwise.com/manage/rest?a=Company&e=CompanyStatuses&o=GET)
