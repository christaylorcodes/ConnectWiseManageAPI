...
online version: https://developer.connectwise.com/manage/rest?a=Procurement&e=Manufacturers&o=GET
schema: 2.0.0
---
...
```
Get-CWMMarketingGroup [[-id] <Int32>] [-count] [[-condition] <String>] [[-orderBy] <String>]
...
## DESCRIPTION
Will return marketing manager groups based on conditions.
...
Will return all marketing manager groups
