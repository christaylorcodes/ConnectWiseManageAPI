...
```
Get-CWMProductType [-id <Int32>] [[-Condition] <String>] [[-orderBy] <String>] [[-childConditions] <String>]
...
[https://developer.connectwise.com/manage/rest?a=Procurement&e=ProductTypes&o=GET](https://developer.connectwise.com/manage/rest?a=Procurement&e=ProductTypes&o=GET)
