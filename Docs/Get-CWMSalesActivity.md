...
```
Get-CWMSalesActivity [-id <Int32>] [[-Condition] <String>] [[-orderBy] <String>] [[-childConditions] <String>]
...
## NOTES
Author: Chris Taylor Date: 12/11/2018

## RELATED LINKS

[https://developer.connectwise.com/products/manage/rest?a=Sales&e=Activities&o=GET](https://developer.connectwise.com/products/manage/rest?a=Sales&e=Activities&o=GET)
