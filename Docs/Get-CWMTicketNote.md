...
```
Get-CWMTicketNote -parentId <Int32> [-id <Int32>] [-count] [[-condition] <String>] [[-orderBy] <String>]
...
[https://developer.connectwise.com/products/manage/rest?a=Service&e=TicketNotes&o=GET](https://developer.connectwise.com/products/manage/rest?a=Service&e=TicketNotes&o=GET)
