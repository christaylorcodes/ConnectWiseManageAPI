...
```
Get-CWMCompanyConfiguration [[-Condition] <String>] [[-orderBy] <String>] [[-childConditions] <String>]
...
[https://developer.connectwise.com/manage/rest?a=Company&e=Configurations&o=GET](https://developer.connectwise.com/manage/rest?a=Company&e=Configurations&o=GET)
