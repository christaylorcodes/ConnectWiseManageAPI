...
online version: https://developer.connectwise.com/Products/Manage/REST?#/BoardTeams
schema: 2.0.0
---
...
```
Get-CWMBoardTeam -parentId <Int32> [-id <Int32>] [-count] [[-condition] <String>] [[-orderBy] <Object>]
...
[https://developer.connectwise.com/Products/Manage/REST?#/BoardTeams](https://developer.connectwise.com/Products/Manage/REST?#/BoardTeams)
