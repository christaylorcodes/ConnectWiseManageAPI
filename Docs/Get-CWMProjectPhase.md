...
```
Get-CWMProjectPhase -parentId <Int32> [-id <Int32>] [-count] [[-condition] <String>] [[-orderBy] <String>]
...
[https://developer.connectwise.com/manage/rest?a=Project&e=ProjectPhases&o=GET](https://developer.connectwise.com/manage/rest?a=Project&e=ProjectPhases&o=GET)
