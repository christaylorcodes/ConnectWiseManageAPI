...
```
Get-CWMBoardStatus -parentId <Int32> [-id <Int32>] [-count] [[-condition] <String>] [[-orderBy] <String>]
...
[https://developer.connectwise.com/products/manage/rest?a=Service&e=BoardStatuses&o=GET](https://developer.connectwise.com/products/manage/rest?a=Service&e=BoardStatuses&o=GET)
