...
```
Get-CWMProjectTeamMember -parentId <Int32> [-id <Int32>] [-count] [[-condition] <String>] [[-orderBy] <String>]
...
[https://developer.connectwise.com/products/manage/rest?a=Project&e=ProjectBoardTeamMembers&o=GET](https://developer.connectwise.com/products/manage/rest?a=Project&e=ProjectBoardTeamMembers&o=GET)
